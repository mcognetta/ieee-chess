...
def _maia_embed(self, input_1):
    ...
    block0_conv2_se_reduce_mean = getattr(self, "block0/conv2/se/reduce_mean")(block0_conv2)
    initializers_onnx_initializer_0 = self.initializers.onnx_initializer_0
    block0_conv2_se_matmul1 = getattr(self, "block0/conv2/se/matmul1")(block0_conv2_se_reduce_mean, initializers_onnx_initializer_0);  block0_conv2_se_reduce_mean = initializers_onnx_initializer_0 = None
    initializers_onnx_initializer_1 = self.initializers.onnx_initializer_1
    block0_conv2_se_add1 = getattr(self, "block0/conv2/se/add1")(block0_conv2_se_matmul1, initializers_onnx_initializer_1);  block0_conv2_se_matmul1 = initializers_onnx_initializer_1 = None
    ...
    block0_conv2_se_matmul2 = getattr(self, "block0/conv2/se/matmul2")(block0_conv2_se_relu, initializers_onnx_initializer_2);  block0_conv2_se_relu = initializers_onnx_initializer_2 = None
    initializers_onnx_initializer_3 = self.initializers.onnx_initializer_3
    block0_conv2_se_add2 = getattr(self, "block0/conv2/se/add2")(block0_conv2_se_matmul2, initializers_onnx_initializer_3);  block0_conv2_se_matmul2 = initializers_onnx_initializer_3 = None
    initializers_onnx_initializer_4 = self.initializers.onnx_initializer_4
    block0_conv2_se_reshape = getattr(self, "block0/conv2/se/reshape")(block0_conv2_se_add2, initializers_onnx_initializer_4);  block0_conv2_se_add2 = initializers_onnx_initializer_4 = None
    ...
    block1_conv2_se_reduce_mean = getattr(self, "block1/conv2/se/reduce_mean")(block1_conv2)
    initializers_onnx_initializer_5 = self.initializers.onnx_initializer_5
    block1_conv2_se_matmul1 = getattr(self, "block1/conv2/se/matmul1")(block1_conv2_se_reduce_mean, initializers_onnx_initializer_5);  block1_conv2_se_reduce_mean = initializers_onnx_initializer_5 = None
    initializers_onnx_initializer_6 = self.initializers.onnx_initializer_6
    block1_conv2_se_add1 = getattr(self, "block1/conv2/se/add1")(block1_conv2_se_matmul1, initializers_onnx_initializer_6);  block1_conv2_se_matmul1 = initializers_onnx_initializer_6 = None
    ...
    block1_conv2_se_matmul2 = getattr(self, "block1/conv2/se/matmul2")(block1_conv2_se_relu, initializers_onnx_initializer_7);  block1_conv2_se_relu = initializers_onnx_initializer_7 = None
    initializers_onnx_initializer_8 = self.initializers.onnx_initializer_8
    block1_conv2_se_add2 = getattr(self, "block1/conv2/se/add2")(block1_conv2_se_matmul2, initializers_onnx_initializer_8);  block1_conv2_se_matmul2 = initializers_onnx_initializer_8 = None
    initializers_onnx_initializer_9 = self.initializers.onnx_initializer_9
    block1_conv2_se_reshape = getattr(self, "block1/conv2/se/reshape")(block1_conv2_se_add2, initializers_onnx_initializer_9);  block1_conv2_se_add2 = initializers_onnx_initializer_9 = None
    ...
    block2_conv2_se_reduce_mean = getattr(self, "block2/conv2/se/reduce_mean")(block2_conv2)
    initializers_onnx_initializer_10 = self.initializers.onnx_initializer_10
    block2_conv2_se_matmul1 = getattr(self, "block2/conv2/se/matmul1")(block2_conv2_se_reduce_mean, initializers_onnx_initializer_10);  block2_conv2_se_reduce_mean = initializers_onnx_initializer_10 = None
    initializers_onnx_initializer_11 = self.initializers.onnx_initializer_11
    block2_conv2_se_add1 = getattr(self, "block2/conv2/se/add1")(block2_conv2_se_matmul1, initializers_onnx_initializer_11);  block2_conv2_se_matmul1 = initializers_onnx_initializer_11 = None
    ...
    block2_conv2_se_matmul2 = getattr(self, "block2/conv2/se/matmul2")(block2_conv2_se_relu, initializers_onnx_initializer_12);  block2_conv2_se_relu = initializers_onnx_initializer_12 = None
    initializers_onnx_initializer_13 = self.initializers.onnx_initializer_13
    block2_conv2_se_add2 = getattr(self, "block2/conv2/se/add2")(block2_conv2_se_matmul2, initializers_onnx_initializer_13);  block2_conv2_se_matmul2 = initializers_onnx_initializer_13 = None
    initializers_onnx_initializer_14 = self.initializers.onnx_initializer_14
    block2_conv2_se_reshape = getattr(self, "block2/conv2/se/reshape")(block2_conv2_se_add2, initializers_onnx_initializer_14);  block2_conv2_se_add2 = initializers_onnx_initializer_14 = None
    ...
    block3_conv2_se_reduce_mean = getattr(self, "block3/conv2/se/reduce_mean")(block3_conv2)
    initializers_onnx_initializer_15 = self.initializers.onnx_initializer_15
    block3_conv2_se_matmul1 = getattr(self, "block3/conv2/se/matmul1")(block3_conv2_se_reduce_mean, initializers_onnx_initializer_15);  block3_conv2_se_reduce_mean = initializers_onnx_initializer_15 = None
    initializers_onnx_initializer_16 = self.initializers.onnx_initializer_16
    block3_conv2_se_add1 = getattr(self, "block3/conv2/se/add1")(block3_conv2_se_matmul1, initializers_onnx_initializer_16);  block3_conv2_se_matmul1 = initializers_onnx_initializer_16 = None
    ...
    block3_conv2_se_matmul2 = getattr(self, "block3/conv2/se/matmul2")(block3_conv2_se_relu, initializers_onnx_initializer_17);  block3_conv2_se_relu = initializers_onnx_initializer_17 = None
    initializers_onnx_initializer_18 = self.initializers.onnx_initializer_18
    block3_conv2_se_add2 = getattr(self, "block3/conv2/se/add2")(block3_conv2_se_matmul2, initializers_onnx_initializer_18);  block3_conv2_se_matmul2 = initializers_onnx_initializer_18 = None
    initializers_onnx_initializer_19 = self.initializers.onnx_initializer_19
    block3_conv2_se_reshape = getattr(self, "block3/conv2/se/reshape")(block3_conv2_se_add2, initializers_onnx_initializer_19);  block3_conv2_se_add2 = initializers_onnx_initializer_19 = None
    ...
    block4_conv2_se_reduce_mean = getattr(self, "block4/conv2/se/reduce_mean")(block4_conv2)
    initializers_onnx_initializer_20 = self.initializers.onnx_initializer_20
    block4_conv2_se_matmul1 = getattr(self, "block4/conv2/se/matmul1")(block4_conv2_se_reduce_mean, initializers_onnx_initializer_20);  block4_conv2_se_reduce_mean = initializers_onnx_initializer_20 = None
    initializers_onnx_initializer_21 = self.initializers.onnx_initializer_21
    block4_conv2_se_add1 = getattr(self, "block4/conv2/se/add1")(block4_conv2_se_matmul1, initializers_onnx_initializer_21);  block4_conv2_se_matmul1 = initializers_onnx_initializer_21 = None
    ...
    block4_conv2_se_matmul2 = getattr(self, "block4/conv2/se/matmul2")(block4_conv2_se_relu, initializers_onnx_initializer_22);  block4_conv2_se_relu = initializers_onnx_initializer_22 = None
    initializers_onnx_initializer_23 = self.initializers.onnx_initializer_23
    block4_conv2_se_add2 = getattr(self, "block4/conv2/se/add2")(block4_conv2_se_matmul2, initializers_onnx_initializer_23);  block4_conv2_se_matmul2 = initializers_onnx_initializer_23 = None
    initializers_onnx_initializer_24 = self.initializers.onnx_initializer_24
    block4_conv2_se_reshape = getattr(self, "block4/conv2/se/reshape")(block4_conv2_se_add2, initializers_onnx_initializer_24);  block4_conv2_se_add2 = initializers_onnx_initializer_24 = None
    ...
    block5_conv2_se_reduce_mean = getattr(self, "block5/conv2/se/reduce_mean")(block5_conv2)
    initializers_onnx_initializer_25 = self.initializers.onnx_initializer_25
    block5_conv2_se_matmul1 = getattr(self, "block5/conv2/se/matmul1")(block5_conv2_se_reduce_mean, initializers_onnx_initializer_25);  block5_conv2_se_reduce_mean = initializers_onnx_initializer_25 = None
    initializers_onnx_initializer_26 = self.initializers.onnx_initializer_26
    block5_conv2_se_add1 = getattr(self, "block5/conv2/se/add1")(block5_conv2_se_matmul1, initializers_onnx_initializer_26);  block5_conv2_se_matmul1 = initializers_onnx_initializer_26 = None
    ...
    block5_conv2_se_matmul2 = getattr(self, "block5/conv2/se/matmul2")(block5_conv2_se_relu, initializers_onnx_initializer_27);  block5_conv2_se_relu = initializers_onnx_initializer_27 = None
    initializers_onnx_initializer_28 = self.initializers.onnx_initializer_28
    block5_conv2_se_add2 = getattr(self, "block5/conv2/se/add2")(block5_conv2_se_matmul2, initializers_onnx_initializer_28);  block5_conv2_se_matmul2 = initializers_onnx_initializer_28 = None
    initializers_onnx_initializer_29 = self.initializers.onnx_initializer_29
    block5_conv2_se_reshape = getattr(self, "block5/conv2/se/reshape")(block5_conv2_se_add2, initializers_onnx_initializer_29);  block5_conv2_se_add2 = initializers_onnx_initializer_29 = None
...
if __name__ == "__main__":
    ...
    model = convert("models/maia-1900.onnx")

    out = _maia_embed(model, torch.from_numpy(leela_board.lcz_features()).float().unsqueeze(0))
    print(out.shape)